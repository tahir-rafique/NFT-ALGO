            ...
            <div className="container mx-auto max-sm:px-5 sm:px-12 lg:px-20 3xl:py-10 ">
                ...
                <div className="flex flex-col gap-0 relative py-10  xl:py-34 ">
                    ...
                    <div className="flex justify-center relative py-40 sm:py-60">
                        <img src={Himg1} alt="" className="absolute left-[20%] top-4 max-lg:left-[10%] max-sm:left-[13%] max-sm:h-64 z-10" />
                        <img src={Himg2} alt="" className="absolute left-[26%] top-4 max-lg:left-[20%] max-sm:left-[18%] max-sm:h-64 z-20" />
                        <img src={Himg3} alt="" className="absolute left-[38%] top-2 z-50 max-lg:left-[30%] max-sm:left-[26%] max-sm:h-66" />
                        <img src={Himg4} alt="" className="absolute left-[50%] top-4 z-10 max-lg:left-[42%] max-sm:left-[38%] max-sm:h-64" />
                        <img src={Himg5} alt="" className="absolute left-[60%] top-4 max-lg:left-[56%]
                        max-sm:left-[46%]  max-sm:h-64 z-8" />
