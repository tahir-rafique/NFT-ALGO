      ...
      <div className="flex justify-center relative">
        ...
        <div className="container mx-auto flex flex-col gap-4 max-sm:px-5 sm:px-12 lg:px-20 py-5">
          <div className="flex flex-col justify-center items-center gap-4 xl:gap-10">
            ...
            <div className="footer-border flex justify-between items-center gap-12 lg:gap-40 2xl:gap-60 3xl:gap-70  px-4 lg:px-8  py-3">
              <input className="font-secondary text-main" placeholder="info@gmail.com" />
