...
const Switch = () => {
    ...
    return (
        <div
            ...
            className={classNames("cursor-pointer flex items-center bg-muted w-17 h-9 mt-2 rounded-full transition-all duration-500 drop-shadow-xs", { 'bg-muted': isSelected })}>
